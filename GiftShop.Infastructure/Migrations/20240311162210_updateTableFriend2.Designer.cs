...
namespace GiftShop.Infastructure.Migrations
{
    ...
    [Migration("20240311162210_updateTableFriend2")]
    partial class updateTableFriend2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GiftShop.Domain.Entities.Friend", b =>
                {
            ...
            modelBuilder.Entity("GiftShop.Domain.Entities.Image", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("GiftShop.Domain.Entities.Product", b =>
                {
                    b.HasOne("GiftShop.Domain.Entities.Brand", null)
                        .WithMany("Products")
                        .HasForeignKey("BrandID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GiftShop.Domain.Entities.Category", null)
                        .WithMany("Products")
